...
public class Keyboard implements KeyListener {
	...
	public Key numPadOne = new Key(), numPadTwo = new Key(), numPadThree = new Key(), numPadFour = new Key(), numPadFive = new Key(), numPadSix = new Key(), numPadSeven = new Key(), numPadEight = new Key(), numPadNine = new Key(), numPadZero = new Key();
	...
	public Key lBrac = new Key(), rBrac = new Key(), comma = new Key(), dot = new Key(), accent = new Key(), colon = new Key(), slash = new Key(), backSlash = new Key();
	...
	public void update () {
		...
		dot.pressed = keys[KeyEvent.VK_PERIOD].pressed;
		accent.pressed = keys[KeyEvent.VK_BACK_QUOTE].pressed;
		colon.pressed = keys[KeyEvent.VK_COLON].pressed;
		...
		dot.typed = keys[KeyEvent.VK_PERIOD].typed;
		accent.typed = keys[KeyEvent.VK_BACK_QUOTE].typed;
		colon.typed = keys[KeyEvent.VK_COLON].typed;
